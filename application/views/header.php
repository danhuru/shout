...
<div id="header">
    ...
    <div id ="rightmenu">
        ...
        <a href="search.php"><img id="settings" width=42px height=42px onmouseover="icon_switch(this,'settings_hover.jpg')" onmouseout="icon_switch(this,'settings.jpg')" src="<?php echo base_url('images/settings.jpg');?>"></img></a>
    ...
    <div id ="mainmenu" onclick="dropdown()">
        ...
        <div id="mainmenu_expanded" onmouseout="dropdown_fade()">
            ...
            <div id="link" onmouseover="dropdown()" onclick="redirect('editprofile')">Log Out</div>
